    ...
    <div>
      <ButtonGroup>
        <div className="game-type__option">
          <Button onClick={onVsPlayerClick} variant="secondary"><IoMan size="6em"/></Button>
          <div className="game-type__option-label">Player vs Player</div>
        </div>
        <hr className="game-type__divider"/>
        <div className="game-type__option">
          <Button onClick={onVsComputerClick} variant="secondary"><RiComputerLine size="6em"/></Button>
